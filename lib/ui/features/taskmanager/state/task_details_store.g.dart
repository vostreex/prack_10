...
mixin _$TaskDetailsStore on _TaskDetailsStore, Store {
  ...
  late final _$toggleItemAsyncAction = AsyncAction(
    '_TaskDetailsStore.toggleItem',
    context: context,
  );

  @override
  Future<void> toggleItem(TaskItem item) {
    return _$toggleItemAsyncAction.run(() => super.toggleItem(item));
  }

  late final _$removeItemAsyncAction = AsyncAction(
    '_TaskDetailsStore.removeItem',
    context: context,
  );

  @override
  Future<void> removeItem(TaskItem item) {
