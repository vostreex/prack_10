...
mixin _$NotesListStore on _NotesListStore, Store {
  ...
  late final _$toggleFavoriteAsyncAction = AsyncAction(
    '_NotesListStore.toggleFavorite',
    context: context,
  );
