...
part 'reflection_form_store_for_new.g.dart';

class ReflectionFormStore = _ReflectionFormStore with _$ReflectionFormStore;

abstract class _ReflectionFormStore with Store {
  final ReflectionEntry? entry;

  _ReflectionFormStore({this.entry}) {
